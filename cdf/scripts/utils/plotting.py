...
def creating_foliumn_map(joined_df, boundaries):
    """
    Creating the Folium map to visualize library and census tract assignment

    Inputs: 
        - joined_df: dataframe from assignment, merging library and census tract
        - boundaries: census tract boundaries
    """
